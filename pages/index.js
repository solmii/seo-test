  ...
  return (
    <div>
      <Head>
        ...
        <meta property='og:url' content='https://solmii.github.io/seo-test/'></meta>
        <meta property='og:title' content='NFTBank.ai'></meta>
        <meta
          property='og:description'
          content='Portfolio - Search and manage Ethereum NFT portfolio on NFTBank.'
        ></meta>
        <meta
          property='og:image'
          content='https://storage.googleapis.com/nftbank-public/nftbank-public/default.png'
        ></meta>

        {/* <!-- Twitter --> */}
        <meta property='twitter:card' content='summary_large_image'></meta>
        <meta property='twitter:url' content='https://solmii.github.io/seo-test/'></meta>
        <meta property='twitter:title' content='NFTBank.ai'></meta>
        <meta
      ...
      <main>
        ...
        <p>askdjhnkasjndfkjadfnkjdsnfkj</p>
      </main>
    </div>
  );
}
